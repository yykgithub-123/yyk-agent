  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">亚克AI超级智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/program-master')">
        <div class="card-glow"></div>
        <div class="app-icon program-icon">💻</div>
        <div class="app-info">
          <div class="app-title">AI编程大师</div>
          <div class="app-desc">智能编程顾问，帮你解答编程烦恼</div>
        </div>
...
// 设置页面标题和元数据
useHead({
  title: '亚克AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: '亚克AI超级智能体应用平台提供AI编程大师和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI编程大师,AI助手,智能对话,亚克,AI超级智能体,首页'
    }
  ]
})
